...
Характеристики:
- 3NF + швидкість
- Ключі написано куплені
- Мов відрізні 30 мілісекунд
- Багато INSERT/UPDATE/DELETE
- Для користувачів ТИСО (Transactional Information System Operations)
...
Характеристики:
- Денормалізовано (швидкість важливіша)
- Майже тільки SELECT, багато JOIN
- Дивлюсь на Табло для швидкості читання
...
OLAP:
3NF - стандарт для транзакційних БД. Але це логіка (є виняткові)